...
import xb.common.utils.HttpUtil;
import xb.jenkins.entity.JenkinInstance;
...
public class JenkinsHelperImpl implements JenkinsHelper {
    ...
    public String createJob(String jobName, String jobConfigXml) {
        String complexJobXml = "<flow-definition plugin=\"workflow-job@2.40\">\n" +
                "    <actions/>\n" +
                "    <description/>\n" +
